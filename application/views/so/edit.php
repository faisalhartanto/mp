...
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" />
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="datepicker"  name="tgl_input" class="form-control" value="<?php echo $so['tgl_input'];?>" readonly="readonly">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-7">
            <input type="text" name="deskripsi" id="deksripsi" class="form-control" value="<?php echo $so['deskripsi'];?>">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-7">
            <input type="text" name="nilai_project" id="nilai_project" class="form-control" value="<?php echo $so['nilai_project'];?>">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="datepicker" id="datepicker2" name="bulan" class="form-control" value="<?php echo $so['bulan'];?>">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-7">
            <input type="text" name="no_po_kesepakatan" id="no_po_kesepakatan" class="form-control" value="<?php echo $so['no_po_kesepakatan'];?>" readonly="readonly">
        </div>
    </div>
	...
	<div class="form-group">
		...
		<select name="rutin" class="form-control alamat" id="rutin">
				<option><?php echo $so['rutin'];?></option>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <select name="po_nonpo" class="form-control alamat" id="berpo">
				<option><?php echo $so['po_nonpo'];?></option>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <select name="status_po" class="form-control alamat" id="berpo">
				<option><?php echo $so['status_po'];?></option>
