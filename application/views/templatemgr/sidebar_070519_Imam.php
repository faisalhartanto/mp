    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li id="lap-data-brg" class="treeview">
                <a href="<?php echo site_url('summary'); ?>">
                    <i class="fa fa-edit"></i> <span>Summary</span></a>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
                <ul class="treeview-menu">
                    <li id="bangunan"><a href=#><i class="fa fa-circle-o"></i>Grafik</a></li>
                </ul>
            </li>
            ...
            <li id="lap-data-brg" class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li id="all"><a href="<?php echo site_url('laporan2/indexall'); ?>"><i class="fa fa-circle-o"></i>
                            All Kategori</a></li>
                    <li id=""><a href="<?php echo site_url('laporan2/excelexport'); ?>"><i class="fa fa-circle-o"></i>
