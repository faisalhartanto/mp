...
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" />
	...
	<div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="datepicker" id="datepicker1" name="tgl_input" class="form-control" value="<?php echo $project['tgl_input'];?>" readonly="readonly">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="text" name="id_main_project" id="id_main_project" class="form-control" value="<?php echo $project['id_main_project'];?>" readonly="readonly">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-7">
            <input type="text" name="no_doc_project" id="no_doc_project" class="form-control" value="<?php echo $project['no_doc_project'];?>">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-7">
            <input type="text" name="deskripsi_project" id="deskripsi_project" class="form-control" value="<?php echo $project['deskripsi_project'];?>">
        </div>
    </div>
