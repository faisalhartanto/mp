<!doctype html>
    <html>
        <head>
			...
			<link rel="icon" type="image/ico" href="<?php echo base_url('assets/img/icon.png');?>">
        ...
        <body>
            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo site_url('web');?>">Building Management System</a>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        <legend>Selamat Datang di Building Management System</legend>
                    </div>
                </div>
            </div>
